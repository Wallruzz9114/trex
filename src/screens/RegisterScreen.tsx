...
import { RegisterFormInput } from '../models/registerFormInput';
...
const RegisterScreen = () => {
  ...
  const _switchToTab = (type: number): void => setCurrentTab(type);
  const _validate = (values: FormikValues) => console.warn(values);
  ...
  return (
    <View style={styles.container}>
      <KeyboardAvoidingView behavior="height" style={styles.centerContainer}>
        ...
        >
          {(formikProps: FormikProps<RegisterFormInput>) => (
            <>
              ...
              <View style={styles.usernameTypesWrapper}>
                <View style={styles.navigationTabs}>
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={_switchToTab.bind(null, 1)}
                    style={{
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={_switchToTab.bind(null, 2)}
                    style={{
                      ...styles.navigationTab,
                    }}
                  >
                    ...
                    <View style={styles.usePhone}>
                      <View
                        style={{
                          ...styles.inputWrapper,
                          borderColor:
                            formikProps.touched.phone && formikProps.errors.phone ? 'red' : '#ddd',
                        }}
                      >
                    ...
                    <View style={styles.useEmail}>
                      <View
                        style={{
                          ...styles.inputWrapper,
                          borderColor:
                            formikProps.touched.email && formikProps.errors.email ? 'red' : '#ddd',
                        }}
                      >
                        <TextInput
